...
#af<-list.files(path='/home/ob219/scratch/pid/VCF/exonic_only/no_monomorphs/lof/gene_events',pattern='*.bcf')
#ag<-sub("([^\\_]+)_.*","\\1",af)
#write(ag,file='/home/ob219/scratch/pid/VCF/event_genes.txt')
...
in.dir<-'/home/ob219/scratch/pid/VCF/exonic_only/no_monomorphs/lof/gene_events'
fpat<-'%s_lof.bcf'
parseVCF<-function(ensg){
	...
	all.info<-merge(info.dt,vep,by.x='row',by.y='row')[,.(WGS10K_AF,GNOMAD_AF,HWE,OPR,SYMBOL,Gene,BIOTYPE,Existing_variation,Consequence,CADD_PHRED,Amino_acids,row)]
