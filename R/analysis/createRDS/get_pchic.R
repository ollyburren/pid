...
saveRDS(cGR(se.idx),file="/home/ob219/scratch/pid/ANNOTATIONS/pchic_hnisz/se.gr.RDS")
saveRDS(cGR(enh.idx),file="/home/ob219/scratch/pid/ANNOTATIONS/pchic_hnisz/enh.gr.RDS")
saveRDS(cGR(se_enh.idx),file="/home/ob219/scratch/pid/ANNOTATIONS/pchic_hnisz/se_enh.gr.RDS")
