...
pse<-readRDS(file.path(DATA.DIR,'pchic_blueprint','se.gr.RDS')) %>% subset(.,ensg %in% genes)
...
library(xlsx)
write.xlsx(final.list, file="/home/ob219/scratch/pid/RESULTS/blueprint_possible_CHET.xlsx", sheetName="all")
...
write.xlsx(pse.anno, file="/home/ob219/scratch/pid/RESULTS/blueprint_possible_CHET.xlsx", sheetName="pse_cell_types")
